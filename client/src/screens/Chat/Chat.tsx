...
import { ArrowLongRightIcon, ChatBubbleLeftRightIcon, HomeIcon, PaperAirplaneIcon } from "@heroicons/react/24/outline";
    ...
    <>
      ...
      <main className={styles.root}>
        ...
        <div className={styles.window}>
          <h2 className={styles.windowHeader}> <ChatBubbleLeftRightIcon width="24px" /> {currentRoom?.name}</h2>
          ...
          <form
            ...
            onSubmit={(e) => {
              e.preventDefault();
              channel?.push("shout", { content: e.target[0].value });
              e.target[0].value = "";
            }}
          >
